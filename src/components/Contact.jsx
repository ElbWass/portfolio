    ...
    <motion.div
      ...
      style={{
        background: isSuccess
          ? "linear-gradient(135deg, #64ffda, #0ea5e9)"
    ...
    <>
      ...
      <div className="xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden">
        <motion.div
          ...
          className="flex-[1.2] bg-black-100 p-10 rounded-2xl"
        >
          <form
            ref={formRef}
          ...
          >
            ...
            <button
              type="submit"
              className="bg-tertiary py-4 px-8 rounded-xl outline-none w-full text-white font-bold shadow-md shadow-primary"
            >
