...
const ExperienceCard = ({ experience, isFr }) => {
  ...
  return (
    <VerticalTimelineElement
      contentStyle={{ background: "#071526", color: "#fff", border: "1px solid rgba(100,255,218,0.2)" }}
      contentArrowStyle={{ borderRight: "7px solid #64ffda" }}
      date={experience.date}
      iconStyle={{ background: experience.iconBg, border: "2px solid #64ffda" }}
      icon={
    ...
    >
      <div>
        ...
        <p className="text-[#64ffda] text-[15px] font-semibold" style={{ margin: 0 }}>
