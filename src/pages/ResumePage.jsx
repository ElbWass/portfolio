      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <a
              href={RESUME_PATH}
              download={isFr ? "CV_EL_Baghdadi_Wassil.pdf" : "Resume_EL_Baghdadi_Wassil.pdf"}
          ...
          {/* PDF preview */}
          <div className="w-full rounded-2xl overflow-hidden border border-[#64ffda]/30 shadow-2xl">
            <div className="bg-[#071526] px-4 py-3 flex items-center justify-between border-b border-[#64ffda]/15">
              ...
              <a
                ...
                className="text-[#64ffda] text-xs hover:underline flex items-center gap-1"
              >
